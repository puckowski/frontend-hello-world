...
var InitialRenderPendingTasks = class _InitialRenderPendingTasks {
  ...
  static {
    this.\u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _InitialRenderPendingTasks, factory: _InitialRenderPendingTasks.\u0275fac, providedIn: "root" });
  }
};
(() => {
